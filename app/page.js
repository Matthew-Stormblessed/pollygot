    ...
    <main className="flex flex-col justify-center items-center h-[100vh]">
      ...
      <section className="flex justify-center items-center bg-white w-[390px] h-full">
        <div className=" flex flex-col border-4 border-[#252F42] w-full h-[505px] m-3.5 pt-[44px] pr-6 pl-6 rounded-2xl">
          ...
          <textarea onKeyDown={handleKeyDown} value={text} onChange={handleChange} className=" mr-1 w-90 pl-3 resize-none font-semibold text-[20px] leading-[150%] tracking-normal text-[#333333] focus:outline-none scrollbar-none field-sizing-content"></textarea>
          <svg onClick={() => {
            Translate();
